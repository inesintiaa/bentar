...
@section('content')
    <div class="d-flex flex-column gap-1">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form class="mx-4" action="{{ route('admin.transaksi.update', $transaksi->id) }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        @foreach ($transaksi->riwayats as $item)
                    ...
                    <div class="mb-3">
                        ...
                        <input id="sub_total" name="sub_total" type="number" class="form-control" id="sub_total"
                            data-custom-message="Tolong isi sub total." value="{{ $transaksi->total_amount }}">
                    </div>
